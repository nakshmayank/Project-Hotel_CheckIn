  ...
  return (
    <div className="py-8 w-full md:px-7 lg:px-16 transition-all">
      ...
      <div className="flex flex-col gap-2">
        ...
        >
          <div className="rounded-full p-2 bg-primary-500 shadow-lg transition-transform hover:scale-110 duration-300 ease-in-out">
            <img className="w-4 h-4" src="/checkin.svg" alt="checkin" />
          </div>

          <div className="bg-primary-500 flex-1 rounded-full px-4 py-2 shadow-lg transition-transform hover:scale-105 duration-300 ease-in-out">
        ...
        <button
          ...
          className="my-1 flex items-center gap-1.5"
        >
          <div className="rounded-full p-2 bg-white/70 shadow-lg transition-transform hover:scale-110 duration-300 ease-in-out">
            <img className="w-5 h-5" src="/dashboard.png" alt="dashboard" />
          </div>
        ...
        <button
          ...
          className="my-1 flex items-center gap-1.5"
        >
          <div className="rounded-full p-2.5 bg-white/70 shadow-lg transition-transform hover:scale-110 duration-300 ease-in-out">
        ...
        <button onClick={logout} className="my-1 flex items-center gap-1.5">
          <div className="rounded-full py-2.5 pl-2 pr-3  bg-white/70 shadow-lg transition-transform hover:scale-110 duration-300 ease-in-out">
