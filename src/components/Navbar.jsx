...
const Navbar = () => {
  ...
  const firstName = user?.FullName?.split(" ")[0] || userData?.Name?.split(" ")[0];
  const fallbackLetter = user?.FullName?.charAt(0)?.toUpperCase() || userData?.Name?.charAt(0)?.toUpperCase() || "U";
  ...
  return (
    <div>
      <nav className="fixed shadow-3xl top-0 transition-all backdrop-blur-sm w-full z-30 px-4 md:px-10 py-5 grid grid-cols-2 md:grid-cols-3 items-center">
        {/* Left - Logo */}
        <div className="">
          <Link to="/" className="items-center">
            {/* <img className="max-w-24" src="/logo.png" alt="" /> */}
            
             <p className="font-bold text-3xl text-gray-700">Stay<span className="text-orange-500">In</span></p>
          </Link>
        </div>

        {/* Center - Menu */}
        <div className="items-center w-full justify-center gap-8 hidden md:flex">
          <Link
            to="/"
          ...
          {user ? (
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-1.5 text-orange-500 border-orange-500 border-2 shadow-md hover:scale-105 ease-in-out duration-300 rounded-lg hover:shadow-lg"
              >
                Sign In
              </button>
              ...
              <button
                ...
                className="px-4 py-2 bg-orange-500 text-white shadow-md hover:scale-105 ease-in-out duration-300 rounded-lg hover:bg-orange-600 hover:shadow-lg"
              >
                Sign Up
              </button>
            </div>
