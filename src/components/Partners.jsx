    ...
    <section className="relative py-12 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-20 space-y-4">
          <span className="inline-block px-4 py-1.5 bg-primary-100 text-primary-500 text-sm font-semibold rounded-full tracking-wide">
            TRUSTED BY INDUSTRY LEADERS
          </span>
          <h2 className="text-4xl font-bold text-gray-900 leading-tight">
            Top Hotels Love Our Platform
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Join a growing community of hotels transforming their guest
            experience
          </p>
        </div>
          ...
          {partners.map((partner, index) => (
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                {/* Divider */}
                <div className="w-12 h-1 bg-gradient-to-r from-primary-500 to-primary-500 group-hover:w-24 transition-all duration-300"></div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex gap-0.5">
                        {[...Array(5)].map((_, i) => (
                          <span
                            key={i}
                            className={`text-sm ${i < Math.floor(parseFloat(partner.rating)) ? "text-yellow-400" : "text-gray-300"}`}
                          >
                            ★
                          </span>
                        ))}
              ...
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-gradient-to-r from-primary-500 to-primary-500 group-hover:w-full transition-all duration-300"></div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-20 text-center space-y-6">
          ...
          <button
            ...
            className="group px-8 py-4 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2 mx-auto"
          >
